...
export default function Login() {
  ...
  // Destructure the auth functions from our context
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-900 text-white p-4">
      ...
      <div className="bg-gray-800 p-6 sm:p-8 rounded-lg shadow-lg w-full max-w-md border border-gray-700">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          />
          <button type="submit" className="bg-red-600 hover:bg-red-700 text-white p-3 rounded font-bold transition transform active:scale-95 shadow-lg shadow-red-900/20">
        ...
        <button 
          ...
          className="w-full bg-white text-gray-800 p-3 rounded font-bold flex items-center justify-center gap-3 hover:bg-gray-100 transition transform active:scale-95"
        >

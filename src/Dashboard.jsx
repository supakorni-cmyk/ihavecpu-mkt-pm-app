        ...
        <div className="h-full w-full bg-gray-50 overflow-y-auto overflow-x-hidden text-gray-900 font-sans relative">
            ...
            <div className="absolute top-0 w-full z-50 bg-gradient-to-b from-white/90 to-transparent px-8 py-4 flex justify-between items-center">
                <div className="flex items-center gap-4">
                    ...
                    <nav className="hidden md:flex gap-4 text-sm font-medium text-gray-500 ml-8">
                        <button className="hover:text-gray-900 transition">Home</button>
                        <button className="hover:text-gray-900 transition">TV Shows</button>
                        <button className="hover:text-gray-900 transition">Movies</button>
                        <button className="hover:text-gray-900 transition">Latest</button>
                    </nav>
                </div>
                <div className="flex gap-3">
                    <button 
                        onClick={() => setIsCreatingAlbum(true)}
                        className="bg-white border border-gray-200 hover:bg-gray-100 text-gray-900 px-4 py-1.5 rounded font-bold text-sm flex items-center gap-2 transition shadow-sm"
                    >
                        <Plus size={16} /> New Album
                    </button>
                    <button 
                        onClick={() => setIsUploadModalOpen(true)}
                        className="bg-red-600 hover:bg-red-700 text-white px-4 py-1.5 rounded font-bold text-sm flex items-center gap-2 transition shadow-sm"
                    >
            ...
            {/* Hero Section - Light Theme Adaptation */}
            <div className="relative w-full h-[65vh]">
                {heroPhoto ? (
                    <img src={heroPhoto.url} className="w-full h-full object-cover object-center opacity-90" />
                ) : (
                ...
                <div className="absolute bottom-20 left-8 md:left-16 max-w-xl">
                    ...
                    <p className="text-lg text-gray-700 font-medium mb-6 line-clamp-3 max-w-lg">
                    ...
                    <div className="flex gap-3">
                        <button className="bg-gray-900 text-white px-6 py-2.5 rounded font-bold flex items-center gap-2 hover:bg-gray-800 transition shadow-lg">
                            <Play fill="white" size={20} /> Play
                        </button>
                        <button className="bg-white/80 text-gray-900 border border-gray-300 px-6 py-2.5 rounded font-bold flex items-center gap-2 hover:bg-white transition backdrop-blur-sm shadow-sm">
                    ...
                    return (
                        <div key={album.id} className="group/row">
                            <div className="flex justify-between items-end mb-3 px-1">
                                <h3 className="text-xl font-bold text-gray-800 group-hover/row:text-red-600 transition duration-300 cursor-pointer flex items-center gap-2">
                                    {album.name} <span className="text-gray-400 text-sm font-normal hidden group-hover/row:inline opacity-0 group-hover/row:opacity-100 transition-opacity duration-500">Explore All &gt;</span>
                                </h3>
                ...
                <div className="fixed inset-0 bg-black/60 z-[60] flex items-center justify-center p-4 backdrop-blur-sm">
                    <div className="bg-white border border-gray-200 rounded-xl w-full max-w-md p-6 shadow-2xl">
                        ...
                        <div className="space-y-4">
                            <div>
                                <label className="block text-xs font-bold text-gray-500 uppercase mb-2">Select Album</label>
                                <select 
                                    className="w-full bg-gray-50 border border-gray-200 rounded p-3 text-gray-900 focus:outline-none focus:border-red-500 transition"
                                    value={targetAlbumId}
                            ...
                            <div className="border-2 border-dashed border-zinc-700 rounded-xl p-8 text-center hover:bg-gray-50 transition relative group">
                                <input 
                                    type="file" 
                                    multiple 
                                    accept="image/*" 
                                ...
                                {uploading ? (
                                    ...
                                    <div className="flex flex-col items-center text-gray-400 group-hover:text-red-600 transition">
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl w-full max-w-sm p-6 shadow-2xl">
                         ...
                         <form onSubmit={handleCreateAlbum} className="flex flex-col gap-4">
                             <input 
                                ...
                                className="bg-gray-50 border border-gray-200 rounded p-3 text-gray-900 focus:outline-none focus:border-red-500"
                                value={newAlbumName}
                                onChange={e => setNewAlbumName(e.target.value)}
                             />
                             <div className="flex justify-end gap-2">
                                 <button type="button" onClick={() => setIsCreatingAlbum(false)} className="px-4 py-2 text-gray-500 hover:text-gray-900 text-sm">Cancel</button>
        ...
        <div className="p-6 md:p-10 h-full w-full bg-gray-50/50 overflow-y-auto">
            <div className="max-w-6xl mx-auto">
                <div className="mb-8">
                    ...
                    <p className="text-gray-500 mt-1">Automated video tracking for monitored channels.</p>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                ...
                                {isCollecting ? 'Scanning...' : 'Run Collector'}
                            </button>
                        </div>
                    </div>
                </div>

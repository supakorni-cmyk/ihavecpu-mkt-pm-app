...
import { Computer, LogOut, Home, Layout, Calendar as CalendarIcon, Presentation, Image as ImageIcon, Table, Heart, UserMinus, Clock, Cat, Clipboard } from 'lucide-react';
  ...
  return (
    <aside className="w-20 md:w-64 bg-white border-r border-gray-200 flex flex-col justify-between flex-shrink-0 z-20 print:hidden">
      <div className="p-6 flex items-center gap-3 mb-6">
        <div className="bg-red-600 p-2 rounded-lg text-white flex-shrink-0"><Cat size={24} /></div>
      ...
      <nav className="px-3 space-y-2">
        ...
        <NavItem view="documents" icon={Clipboard} label="Document View" />
